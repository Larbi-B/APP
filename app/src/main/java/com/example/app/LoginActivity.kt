...
//  Click
    ...
    private fun showTextMinimalAlert(isNotValid: Boolean, text: String){
        if (text == "Email/Username")
            binding.etEmail.error = if (isNotValid) "le champ ne doit pas être vide !" else null
        else if (text == "Password")
            binding.etPassword.error = if (isNotValid) "le champ ne doit pas être vide !" else null
    }
